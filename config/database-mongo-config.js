...
module.exports = (url) => {
    ...
    mongoose.connect(`mongodb+srv://${config.get('database_mongo_ip')}`, { useNewUrlParser: true }); //Testa ajuste: { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false }
